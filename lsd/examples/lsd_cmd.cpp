 ...
 */
static void
free_arguments(struct arguments* arg) {
 ...
 */
static char*
get_next_field(char* p, char* id, char* value) {
  int n;
 ...
 */
static char*
get_next_token(char* p, char div, char* value) {
  int n;
 ...
 */
static void
process_new_argument(char* id, char* value, struct arguments* arg) {
  ...
  if(arg->arg_num >= arg->arg_allocated) {
    arg->arg_allocated *= 2;
    arg->args = (struct argument*)realloc((void*)arg->args, arg->arg_allocated * sizeof(struct argument));
    if(arg->args == NULL)
 ...
 */
static void
process_argument_description(char* desc, struct arguments* arg) {
 ...
 */
static void
print_version(struct arguments* arg, FILE* f) {
  if(arg == NULL || f == NULL)
 ...
 */
static void
evaluate_arguments(int argc, char** argv, struct arguments* arg) {
...
process_arguments(char* desc, int argc, char** argv) {
 ...
 */
static int
is_assigned(struct arguments* arg, char* name) {
  int i;
 ...
 */
static char*
get_str(struct arguments* arg, char* name) {
  int i;
 ...
 */
static int
get_int(struct arguments* arg, char* name) {
  int i;
 ...
 */
static double
get_double(struct arguments* arg, char* name) {
  int i;
 ...
 */
static void
skip_whites_and_comments(FILE* f) {
  int c;
  do {
 ...
 */
static double*
read_pgm_image_double(int* X, int* Y, char* name) {
  FILE* f;
  int c, bin;
  ...
  /* read data */
  for(y = 0; y < ysize; y++)
    for(x = 0; x < xsize; x++) image[x + y * xsize] = bin ? (double)getc(f) : (double)get_num(f);
 ...
 */
static void
write_pgm_image_int(int* image, int xsize, int ysize, char* name) {
  FILE* f;
  int x, y, n, v, max, min;
 ...
 */
static void
write_eps(double* segs, int n, int dim, char* filename, int xsize, int ysize, double width) {
  FILE* eps;
  int i;
...
*/
static void
write_svg(double* segs, int n, int dim, char* filename, int xsize, int ysize, double width) {
  FILE* svg;
  int i;

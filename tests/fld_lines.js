...
function main(...args) {
  ...
  for(const input of args) {
     ...
     * an algorithm takes much longer. So here we run the algorithm 5 times to see
     * the algorithm's processing time with sufficiently warmed-up CPU performance.
     */
    ...
    /*console.log(
      'lines',
      console.config({ maxArrayLength: Infinity }),
      [...lm].map(l => [...l]),
    );*/

    imshow('FLD result', line_image_fld);
    let rect = getWindowImageRect('FLD result');

import { Mat, Point, Line, Size, VideoWriter, CAP_GSTREAMER, CV_8UC3, LINE_AA, VIDEOWRITER_PROP_FRAMEBYTES, line } from 'opencv';
...
function main() {
  ...
  line(mat, new Point(0, size.height), new Point(size.width, 0), [0xdd, 0xdd, 0xdd], 2, LINE_AA);
  ...
  for(const c of [
    ...
    mat.setTo(c);
    line(mat, new Line(0, 0, ...size), [0xdd, 0xdd, 0xdd], 2, LINE_AA);
    repeat(rate, () => vw.write(mat));

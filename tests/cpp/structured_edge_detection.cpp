...
const char* keys = {"{i || input image file name}"
                    "{m || model file name}"
...
main(int argc, char* argv[]) {
  ...
  String modelFilename = "model.yml";                       // parser.get<String>("m");
  String inFilename = "tests/test_linesegmentdetector.jpg"; // parser.get<String>("i");

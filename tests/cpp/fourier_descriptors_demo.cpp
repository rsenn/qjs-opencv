...
main(void) {
  ...
  ctrRef.push_back(Point(250, 250));
  ctrRef.push_back(Point(400, 250));
  ctrRef.push_back(Point(400, 300));
  ctrRef.push_back(Point(250, 300));
  ctrRef.push_back(Point(180, 270));
  Point cg(0, 0);
...
vector<Point>
NoisyPolygon(vector<Point> pRef, double n) {
  RNG rng;
  vector<Point> c;
  vector<Point> p = pRef;

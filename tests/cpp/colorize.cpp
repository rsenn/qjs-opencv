...
#ifdef HAVE_EIGEN
static void
mouseCallback(int event, int x, int y, int, void*) {
  switch(event) {
...
void
drawTrajectoryByReference(cv::Mat& img) {
  int i, j;
...
// draw the hsv-plate
void
createPlate(Mat& im1, int radius) {

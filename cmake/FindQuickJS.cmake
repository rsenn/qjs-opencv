macro(find_quickjs)
  ...
  if(NOT QUICKJS_INCLUDE_DIR)
    ...
    if(NOT EXISTS "${QUICKJS_INCLUDE_DIR}/quickjs.h")
      if(EXISTS "${CMAKE_CURRENT_BINARY_DIR}/../quickjs/quickjs.h")
        set(QUICKJS_INCLUDE_DIR "${CMAKE_CURRENT_BINARY_DIR}/../quickjs")
      else(EXISTS "${CMAKE_CURRENT_BINARY_DIR}/../quickjs/quickjs.h")
        ...
        else(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/../quickjs/quickjs.h")
          if(EXISTS "${QUICKJS_PREFIX}/include/quickjs")
            set(QUICKJS_INCLUDE_DIR "${QUICKJS_PREFIX}/include/quickjs")
          endif(EXISTS "${QUICKJS_PREFIX}/include/quickjs")
        endif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/../quickjs/quickjs.h")
  ...
  set(CUTILS_H ${CMAKE_CURRENT_SOURCE_DIR}/../quickjs/cutils.h)
  set(QUICKJS_H ${CMAKE_CURRENT_SOURCE_DIR}/../quickjs/quickjs.h)

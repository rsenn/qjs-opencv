...
file(GLOB IMGUI_VIEWER_SOURCES color.cpp data.cpp geometry.cpp js.cpp jsbindings.cpp plot-cv.cpp js_*.cpp line.cpp matrix.cpp polygon.cpp util.cpp *.h *.hpp)
...
# Main
add_executable(imgui-viewer imgui-viewer.cpp imgui/imgui.cpp imgui/imgui_draw.cpp imgui/imgui_widgets.cpp imgui/imgui_impl_sdl.cpp imgui/imgui_impl_opengl3.cpp imgui/libs/gl3w/GL/gl3w.c ${IMGUI_VIEWER_SOURCES})
...
# link
target_link_libraries(imgui-viewer ${SDL2_LIBRARIES} ${OpenCV_LIBS} glfw ${OPENGL_LIBRARIES} ${GLFW_LIBRARIES} ${GLEW_LIBRARIES} ${EXTRA_LIBS} quickjs png ${LIBDL} ${LIBM} ${LIBPTHREAD} GL)
if(OpenCV_FOUND)

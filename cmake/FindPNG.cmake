...
if(ZLIB_FOUND)
  ...
  if(PNG_FIND_VERSION MATCHES "^([0-9]+)\\.([0-9]+)(\\..*)?$")
    ...
    if(PNG_FIND_VERSION_EXACT)
      ...
      string(REGEX REPLACE "${_PNG_VERSION_SUFFIX_MIN}.*" "${_PNG_VERSION_SUFFIX_MIN}"
  ...
  if(PNG_LIBRARY AND PNG_PNG_INCLUDE_DIR)
    ...
    if((CMAKE_SYSTEM_NAME STREQUAL "Linux") AND ("${PNG_LIBRARY}" MATCHES
    ...
    if(NOT TARGET PNG::PNG)
      ...
      set_target_properties(
        ...
        PROPERTIES INTERFACE_COMPILE_DEFINITIONS "${_PNG_COMPILE_DEFINITIONS}"
                   INTERFACE_INCLUDE_DIRECTORIES "${PNG_INCLUDE_DIRS}" INTERFACE_LINK_LIBRARIES
                                                                       ZLIB::ZLIB)
      if((CMAKE_SYSTEM_NAME STREQUAL "Linux") AND ("${PNG_LIBRARY}" MATCHES
                                                   "\\${CMAKE_STATIC_LIBRARY_SUFFIX}$"))
      ...
      if(EXISTS "${PNG_LIBRARY_RELEASE}")
        ...
        set_target_properties(
          PNG::PNG PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
      ...
      if(EXISTS "${PNG_LIBRARY_DEBUG}")
        ...
        set_target_properties(PNG::PNG PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
  ...
  if(PNG_PNG_INCLUDE_DIR AND EXISTS "${PNG_PNG_INCLUDE_DIR}/png.h")
    ...
    string(REGEX REPLACE "^#define[ \t]+PNG_LIBPNG_VER_STRING[ \t]+\"([^\"]+)\".*" "\\1"
                         PNG_VERSION_STRING "${png_version_str}")

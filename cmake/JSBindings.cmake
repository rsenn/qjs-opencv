...
function(make_shared_module FNAME)
  ...
  set_target_properties(
    ${TARGET_NAME}
    PROPERTIES LINK_DIRECTORIES "${jsbindings_LINK_DIRECTORIES}" PREFIX "" # BUILD_RPATH "${OPENCV_LIBRARY_DIRS}:${CMAKE_CURRENT_BINARY_DIR}"
               RPATH "${OPENCV_LIBDIR}:${CMAKE_INSTALL_PREFIX}/lib:${QUICKJS_C_MODULE_DIR}" OUTPUT_NAME "${NAME}" COMPILE_FLAGS "${QUICKJS_MODULE_CFLAGS}"
               BUILD_RPATH "${CMAKE_CURRENT_BINARY_DIR}:${CMAKE_CURRENT_BINARY_DIR}/quickjs:${CMAKE_CURRENT_BINARY_DIR}/quickjs:${QUICKJS_C_MODULE_DIR}")

...
import {
  setMouseCallback,
  EVENT_LBUTTONDOWN, EVENT_LBUTTONUP, EVENT_MOUSEMOVE, EVENT_MOUSEWHEEL,
} from 'opencv.so';

export const MouseEvent = {
  DOWN: EVENT_LBUTTONDOWN, UP: EVENT_LBUTTONUP,
  MOVE: EVENT_MOUSEMOVE, WHEEL: EVENT_MOUSEWHEEL,
};

export class Mouse {
  constructor(windowName) {
    this.queue = [];
    this.x = 0; this.y = 0; this.down = false;

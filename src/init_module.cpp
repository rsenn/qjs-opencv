...
extern "C" int js_pointvector_init(JSContext*, JSModuleDef*);
extern "C" int js_pointvectorvector_init(JSContext*, JSModuleDef*);
extern "C" int js_rectvector_init(JSContext*, JSModuleDef*);
extern "C" int js_keypointvector_init(JSContext*, JSModuleDef*);
extern "C" int js_dmatchvector_init(JSContext*, JSModuleDef*);
extern "C" int js_primitivevectors_init(JSContext*, JSModuleDef*);
...
extern "C" void js_dmatch_export(JSContext*, JSModuleDef*);
...
extern "C" void js_matvector_export(JSContext*, JSModuleDef*);
extern "C" void js_pointvector_export(JSContext*, JSModuleDef*);
extern "C" void js_pointvectorvector_export(JSContext*, JSModuleDef*);
extern "C" void js_rectvector_export(JSContext*, JSModuleDef*);
extern "C" void js_keypointvector_export(JSContext*, JSModuleDef*);
extern "C" void js_dmatchvector_export(JSContext*, JSModuleDef*);
extern "C" void js_primitivevectors_export(JSContext*, JSModuleDef*);
...
js_opencv_init(JSContext* ctx, JSModuleDef* m) {
  ...
  // js_matx_init(ctx, m);
  js_matvector_init(ctx, m);
  js_pointvector_init(ctx, m);
  js_pointvectorvector_init(ctx, m);
  js_rectvector_init(ctx, m);
  js_keypointvector_init(ctx, m);
  js_dmatchvector_init(ctx, m);
  js_primitivevectors_init(ctx, m);
  js_aruco_init(ctx, m);
  js_dnn_init(ctx, m);
...
JS_INIT_MODULE(JSContext* ctx, const char* module_name) {
  ...
  js_matvector_export(ctx, m);
  js_pointvector_export(ctx, m);
  js_pointvectorvector_export(ctx, m);
  js_rectvector_export(ctx, m);
  js_keypointvector_export(ctx, m);
  js_dmatchvector_export(ctx, m);
  js_primitivevectors_export(ctx, m);
